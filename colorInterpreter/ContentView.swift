...
struct ContentView: View {
    ...
    private var textColor: Color {
        isLightColor(red: redValue, green: greenValue, blue: blueValue) ? .black : .white
    }
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                Text("RGB").bold().foregroundColor(textColor)
                ...
                Text("CMYK").bold().foregroundColor(textColor)
                ...
                Text("HLS").bold().foregroundColor(textColor)
    ...
    func isLightColor(red: Double, green: Double, blue: Double) -> Bool {
        // Проверка на светлый или тёмный фон по формуле YIQ
